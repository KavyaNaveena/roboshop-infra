parameters = [
  ...
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.learndevopsb71club.sitee:8080/", type = "String" },
  ...
  { name = "dev.user.mongo_url", value = "mongodb://mongodb-dev.learndevopsb71club.site:27017/catalogue", type = "String" },
  ...
  { name = "dev.catalogue.mongo_url", value = "mongodb://mongodb-dev.learndevopsb71club.site:27017/users", type = "String" },
